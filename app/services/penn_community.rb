class PennCommunity
  ...
  def self.getUser(id = nil)
    ...
    /* CHOP */
        ...
        'CHOP' AS DEPT,
        'CHOP' AS RANK
        FROM DCCSADMIN.PERSON_DIRECTORY PD, COMADMIN.SSN4_AFFILIATION_VIEW SAV, COMADMIN.SSN4_MEMBER_VIEW SMV
    ...
    /* STAF or TEMP or PGUE */
        ...
        'Staff' AS RANK
        FROM DCCSADMIN.PERSON_DIRECTORY PD, COMADMIN.SSN4_AFFILIATION_VIEW SAV, COMADMIN.SSN4_MEMBER_VIEW SMV, PCADMIN.ORGANIZATION O
